  ...
  <div class="register-logo">
    ...
    <div class="card">
        ...
        <form action="functions/studentvalidation.php" method="post">
            ...
            <div class="input-group mb-3">
            <input placeholder="Birthday" class="form-control" type="text" onfocus="(this.type='date')" id="a_bDay" name="a_bDay">
            <div class="input-group-append">
                <div class="input-group-text">
                </div>
            </div>
            ...
            <input type="text" class="form-control" id="a_yearGraduated" min="1900" max="2099" placeholder="Year Graduated" name="a_yearGraduated"/>
            <div class="input-group-append">
                <div class="input-group-text">
                </div>
            </div>
