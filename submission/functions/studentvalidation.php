...
$a_yearGraduated = $_POST['a_yearGraduated'];
...
if(empty($a_studNo)){
    ...
    $sql = "INSERT INTO r_student (student_studNo, student_fName, student_mName, student_lName, student_bDay, student_sex, 
student_civilStatus, student_addCity, student_addProvince, student_addPostal, student_course, student_yearGraduated) 
    VALUES ('$a_studNo', '$a_fName', '$a_mName', '$a_lName', '$a_bDay', '$a_sex', '$a_civilStatus',
    '$a_addCity', '$a_addProvince', '$a_addPostal', '$a_course', '$a_status', '$a_yearGraduated')";
    ...
    student_civilStatus, student_addCity, student_addProvince, student_addPostal, student_yearGraduated) 
    VALUES ('$a_studNo', '$a_fName', '$a_mName', '$a_lName', '$a_bDay', '$a_sex', '$a_civilStatus',
    '$a_addCity', '$a_addProvince', '$a_addPostal', '$a_yearGraduated')") 
